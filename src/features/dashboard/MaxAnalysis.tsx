...
const MaxAnalysis = ({ value,grade,status }: { value: number,grade:string,status:string }) => {
  ...
  return (
    <div className="w-full h-full rounded-lg flex flex-col p-4 bg-white justify-between">
      <div className="flex justify-between items-center">
        <div className="text-lg font-semibold text-black ">Max Analysis</div>
